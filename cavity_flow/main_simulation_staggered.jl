...
include("./cavity_functions_staggered.jl"); using .cavity_functions
...
writedlm(folder*"/u_velocity_field_staggered.txt", u, ',')
writedlm(folder*"/v_velocity_field_staggered.txt", v, ',')
writedlm(folder*"/pressure_field_staggered.txt", p, ',')
writedlm(folder*"/divergence_field_staggered.txt", div, ',')
writedlm(folder*"/X_coordinate_field_staggered.txt", X, ',')
writedlm(folder*"/y_coordinate_field_staggered.txt", Y, ',')
writedlm(folder*"/x_coordinate_staggered.txt", x, ',')
writedlm(folder*"/y_coordinate_staggered.txt", y, ',')